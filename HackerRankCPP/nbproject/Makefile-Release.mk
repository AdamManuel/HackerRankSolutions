...
${OBJECTDIR}/Balanced_Trees.o: Balanced_Trees.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Balanced_Trees.o Balanced_Trees.cpp

${OBJECTDIR}/Introduction.o: Introduction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Introduction.o Introduction.cpp
